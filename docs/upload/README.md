...
Dieses Verzeichnis enthält die Schema-Definition + Beispiele für den Upload-Workflow.

- **Architektur-Überblick:** [`docs/architecture/upload-workflow.md`](../architecture/upload-workflow.md)
...
Der JSON-Export aus erfüllt dieses Schema. Ein exportiertes Bundle kann ohne Änderung als Upload in einen anderen Tenant eingespielt werden. Siehe [`docs/architecture/upload-workflow.md`](../architecture/upload-workflow.md#round-trip-mit-export).
