...
return [
    ...
    'pages' => [
        ...
        'manage_integrations' => [
            ...
            'config_description' => 'Die Verbindungsdaten werden über Umgebungsvariablen (.env) konfiguriert und können hier nicht bearbeitet werden.',
            'api_url' => 'API-URL',
            ...
            'info_text' => 'Diese Integration verbindet das Dashboard mit einer CIVITAS/CORE Instanz. Kacheln, Kategorien und Messwerte werden automatisch abgeglichen. Die Konfiguration der Verbindungsdaten erfolgt über Umgebungsvariablen in der .env-Datei.',
        ],
        'edit_profile' => [
            'title' => 'Profil',
