...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Standard German translations from laravel-lang/lang.
    ...
    */
    ...
    'required_if_declined' => ':Attribute muss ausgefüllt werden, wenn :other abgelehnt wird.',
    ...
    |--------------------------------------------------------------------------
    |
    | Maps form field names to German labels so validation messages
    | read naturally (e.g. "E-Mail muss ausgefüllt werden" instead of
