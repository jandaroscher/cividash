...
return [
    ...
    'pages' => [
        ...
        'manage_integrations' => [
            ...
            'config_description' => 'Connection details are configured via environment variables (.env) and cannot be edited here.',
            'api_url' => 'API URL',
            ...
            'info_text' => 'This integration connects the dashboard with a CIVITAS/CORE instance. Tiles, categories, and metric values are synchronised automatically. Connection details are configured via environment variables in the .env file.',
        ],
        'manage_general' => [
            'title' => 'Site Settings',
            'site_name' => 'Site name',
