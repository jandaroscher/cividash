...
class FilterApiTest extends TestCase
{
    ...
    {
        $group = CategoryGroup::factory()->filterable()->forTenant($this->tenant)->create([
            'key' => 'fields',
    ...
    {
        $group1 = CategoryGroup::factory()->filterable()->forTenant($this->tenant)->create([
            'key' => 'fields',
            'title' => ['de' => 'Handlungsfelder', 'en' => 'Action Fields'],
            'position' => 0,
        ]);

        $group2 = CategoryGroup::factory()->filterable()->forTenant($this->tenant)->create([
            'key' => 'dimensions',
    ...
    {
        CategoryGroup::factory()->filterable()->forTenant($this->tenant)->create([
            'key' => 'fields',
            'title' => ['de' => 'Handlungsfelder', 'en' => 'Action Fields'],
            'position' => 0,
        ]);
    ...
    public function test_non_filterable_groups_are_excluded(): void
    {
        CategoryGroup::factory()->filterable()->forTenant($this->tenant)->create([
            'key' => 'filterable-group',
            'title' => ['de' => 'Filterbar', 'en' => 'Filterable'],
            'position' => 0,
        ]);

        CategoryGroup::factory()->forTenant($this->tenant)->create([
            'key' => 'non-filterable-group',
            'title' => ['de' => 'Nicht filterbar', 'en' => 'Not Filterable'],
            'is_filterable' => false,
            'position' => 1,
        ]);
        ...
        $groups = $response->json('data.groups');
        $this->assertCount(1, $groups);
        $this->assertEquals('filterable-group', $groups[0]['key']);
    }
